...
namespace Pixills.Consul.Client.UnitTests
{
    public class HttpConnection
    {
        ...
        public void HttpConnection_Constructor_CallWithInvalidUrl_ShouldThrowException()
        {
            ...
            {
                new Consul.Client.HttpConnection("this is an invalid URL", _client, true, 5);
            });
        }
        ...
        public void HttpConnection_Constructor_CallWithNullUrl_ShouldThrowException()
        {
            Assert.Throws<ArgumentException>(() =>
            {
                new Consul.Client.HttpConnection(null, _client, true, 5);
            });
        }
        ...
        public void HttpConnection_Constructor_CallWithNullClient_ShouldThrowException()
        {
            Assert.Throws<ArgumentException>(() =>
            {
                new Consul.Client.HttpConnection("localhost:1337", null, true, 5);
            });
        }
        ...
        {
            var con = new Consul.Client.HttpConnection("localhost:1337", _client, true, 5);
        }

        [Fact]
        public void HttpConnection_Constructor_CallWithLeastParameters_ShouldNotThrowException()
        {
            var con = new Consul.Client.HttpConnection("localhost:1337", _client);
        }

        [Fact]
        public void HttpConnection_Constructor_CallWithHostWithHttpPrefix_ShouldRemoveHttpPrefix()
        {
            var con = new Consul.Client.HttpConnection("http://localhost:1337", _client);
        ...
        {
            var con = new Consul.Client.HttpConnection("localhost:1337", _client, true);
        ...
        {
            var con = new Consul.Client.HttpConnection("localhost:1337", _client, true, 0);
